...
class Review(BaseModel):
    ...
    pros: Optional[list[str]] = Field (default = [],description= "Write down all the pros inside a list")
    cons: Optional[list[str]] = Field(description="Write down all the cons inside a list", default=[])
